  ...
  return (
    <div className="container-fluid mt-5 pt-5">
      ...
      <div className="d-flex justify-content-center mb-4" style={{ position: "relative" }}>
        {/* Gambar */}
        <img
          src="https://i.pinimg.com/736x/35/da/16/35da16116897b8fb2cfdd8dba1086b62.jpg"
          className="img-fluid"
        ...
        >
          <p style={{ fontWeight: "bold" }}>BERITA INDONESIA</p>
          <p style={{ fontSize: "1.5rem" }}>
            Yukk baca selengkapnya mengenai berita terkini Indonesia
          </p>
          <button
