  ...
  return (
    <div className="container-fluid mt-5 pt-5">
      ...
      <div className="d-flex justify-content-center mb-4" style={{ position: "relative" }}>
        ...
        {/* gambar */}
        <img
          src="https://caraguna.com/wp-content/uploads/2022/02/programmer.jpg"
          className="img-fluid"
          alt="Programming & Teknologi"
          style={{
            width: "100vw",
            height: "100vh",
            objectFit: "cover",
        ...
        >
          <p style={{ fontWeight: "bold" }}>BERITA PROGRAMMING</p>
          <p style={{ fontSize: "1.5rem" }}>
            Yukk baca selengkapnya mengenai berita terkini seputar programming
          </p>
          <button
